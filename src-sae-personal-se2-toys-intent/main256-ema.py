...
def main():
    ...
    parser.add_argument("--output_dir", default="../output_sae2_se_toys_intent/", type=str)
    ...
    parser.add_argument("--intent_file_path", type=str, default="/data2/jx39280/ICSRec-main/case_study/toys/case_data/toys_TopK15_l8_epoch45_encoder_16384_keep15_5000_conceptsummary_intent.txt", help="trained sae path")
