...
topk为5？10？15？20？
针对每个用户取出对应的intent集合，保持256的batch，不是每256个用户共同的intent，是256中每个用户的intent！
'''
...
def main():
    ...
    parser.add_argument("--output_dir", default="../output_sae2/", type=str)
    ...
    parser.add_argument("--align_weight", type=float, default=0.5, help="weight of contrastive learning task")
