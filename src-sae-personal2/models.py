...
class SASRecModel(nn.Module):
    ...
    def forward(self, input_ids, topk_ids): # (b,l), (b,)
        ...
        item_encoded_layers, memory_tensor, query_repr, attention_scores_mean = self.item_encoder(sequence_emb, extended_attention_mask, topk_ids, output_all_encoded_layers=True)
