...
def main():
    ...
    parser.add_argument("--output_dir", default="../output_sae2_se_nosec/", type=str)
    ...
    indices, latent_init_tensor2 = select_intent(args.intent_file_path, sae_w) # 1208 torch.Size([1208, 768]) cuda:2
