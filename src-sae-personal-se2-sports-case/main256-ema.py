...
'''
TopK15_l8_epoch50_encoder_32768_sports
'''
...
def main():
    ...
    parser.add_argument("--output_dir", default="../output_sae2_se_sports/", type=str)
    ...
    parser.add_argument("--sae_file_path", type=str, default="../trained_sae/sae_model/sports/TopK15_l8_epoch50_encoder_32768_sports.pth", help="trained sae path")
    # parser.add_argument("--sae_file_path", type=str, default="../trained_sae/sae_model/sports/TopK15_l8_epoch50_encoder_16384_sports.pth", help="trained sae path")
