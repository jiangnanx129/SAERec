...
def main():
    ...
    parser.add_argument("--output_dir", default="../output_sae2_se_noema/", type=str)
    ...
    if args.encoder=="SAS":
        ...
        model = SASRecModel(args=args, latent_init_tensor=latent_init_tensor, indices = indices) # latent_init_tensor (1000,768)
