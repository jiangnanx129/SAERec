    ...
    def iteration(self, epoch, dataloader, cluster_dataloader=None, full_sort=True, train=True):
        ...
        if train:
            ...
            for i, (rec_batch) in rec_cf_data_iter:
                ...
                # ---------- prediction task -----------------------#
                intent_output, memory_tensor, query_repr, attention_scores_mean = self.model(subsequence_1)
            ...
            if full_sort:
                ...
                for i, batch in rec_data_iter:
                    ...
                    recommend_output, memory_tensor, query_repr, attention_scores_mean = self.model(input_ids) # [BxLxH]
