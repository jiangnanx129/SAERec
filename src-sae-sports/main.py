...
from models import SASRecModel,GRUEncoder, SASRecModel_item, SASRecModel_item2, SASRecModel_item3
...
def main():
    ...
    parser.add_argument("--output_dir", default="../output_sae_intent2/", type=str)
    ...
    parser.add_argument("--sae_file_path", type=str, default="../trained_sae/sae_model/TopK15_l8_epoch30_encoder_32768_sports.pth", help="trained sae path")
    parser.add_argument("--intent_file_path", type=str, default="../trained_sae/intent_select/tunelens_sports_TopK15_l8_epoch30_encoder_32768_keep15_mistral_prompt3_5000_intent.txt", help="trained sae path")
